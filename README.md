...
- SQL (Commn Table Expressions, Joins, Filtering)
...
'''bash
git clone https://github.com/yourusername/vendor-performance-analysis-sql-python-powerbi.git
'''
